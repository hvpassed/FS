...
namespace FixMath.NET
{
    ...
    /// </summary>
    [MessagePackObject]
    public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>,IFSSerializable {
        [Key(0)]
...
@"
        ...
        // {
	       //  var fix64 = MessagePackSerializer.Deserialize<Fix64>(data,ContractlessStandardResolverAllowPrivate.Options);
	       //  this.m_rawValue = fix64.RawValue;
        // }
    }
}
