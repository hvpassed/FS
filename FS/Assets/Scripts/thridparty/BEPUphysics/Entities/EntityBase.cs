        ...
        IEquatable<Entity>
    {
        ...
        public Fix64 Mass
        {
            ...
            set
            {
                ...
                // if (value <= 0 || Fix64Utils.IsNaN(value) || Fix64.IsInfinity(value))
				if (value <= 0)
					BecomeKinematic();
                else
                {
        ...
        void IForceUpdateable.UpdateForForces(Fix64 dt)
        {
                ...
                (activityInformation.isSlowing || activityInformation.velocityTimeBelowLimit > activityInformation.DeactivationManager.lowVelocityTimeMinimum))
            {
                ...
                {
                    Fix64 boost = 1 - Fix64.Sqrt(energy) / (2 * activityInformation.DeactivationManager.velocityLowerLimit);
        ...
        void IPositionUpdateable.PreUpdatePosition(Fix64 dt)
        {
            ...
            Vector3.Multiply(ref angularVelocity, dt * Fix64Utils.PointFive, out increment);
        ...
        public void ModifyLinearDamping(Fix64 damping)
        {
            ...
            Fix64 remainder = 1 - totalDamping;
