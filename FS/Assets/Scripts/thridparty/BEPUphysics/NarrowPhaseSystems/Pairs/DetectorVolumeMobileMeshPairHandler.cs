    ...
    public class DetectorVolumeMobileMeshPairHandler : DetectorVolumePairHandler
    {
        ...
        public override void UpdateCollision(Fix64 dt)
        {
            ...
            for (int i = 0; i < meshData.Indices.Length; i += 3)
            {
                ...
                Vector3.Multiply(ref mobileTriangleTransform.Position, Fix64Utils.OneThird, out mobileTriangleTransform.Position);
                ...
                for (int j = 0; j < overlaps.Count; j++)
                {
                    ...
                    Vector3.Multiply(ref detectorTriangleTransform.Position, Fix64Utils.OneThird, out detectorTriangleTransform.Position);
